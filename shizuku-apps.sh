#!/system/bin/sh
# shizuku-apps.sh — fetch + silently install hand-picked apps from awesome-shizuku
#
# HOW TO RUN (pick one):
...
github "ObtainX" dev.bikram.obtainx bikram-agarwal/ObtainX   # Obtainium fork w/ Material 3 Expressive UI — auto-updates sideloaded apps
